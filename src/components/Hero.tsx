      ...
      <div className="absolute top-6 left-6 z-50 animate-fade-in suz-logo-container suz-hero-logo">
        <div className="suz-card-glass suz-logo-wrapper rounded-3xl border border-white/30 shadow-xl logo-glow group">
          <img
            ...
            alt="SUZ Reinigung Logo - Deutschlands führender Reinigungsservice seit 2000. Premium Büroreinigung, Hausreinigung und Spezialreinigung."
            title="SUZ Reinigung - Premium Reinigungsdienstleistungen Deutschland"
