...
const Fensterreinigung = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-sky-50">
      ...
      {/* Hero Section */}
      <section className="relative py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-sky-900 to-blue-900">
      ...
      {/* Final CTA */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-sky-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center">
