...
const Fensterreinigung = () => {
  const service = getServiceById(SERVICE_TYPES.FENSTERREINIGUNG);
  ...
  return (
    <div className="min-h-screen bg-premium-gradient force-apple-design">
      ...
      {/* Hero Section */}
      <section className="relative py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-sky-600 to-blue-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              ...
              className="border-2 border-white text-white hover:bg-white hover:text-sky-700 px-8 py-4 rounded-lg text-lg font-semibold transition-colors flex items-center justify-center gap-2"
            >
            ...
            {service.features.map((feature, index) => (
              <div key={index} className="suz-card-glass p-6 rounded-lg hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-3">
                  <svg className="h-6 w-6 text-sky-400 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Final CTA */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-sky-600 to-blue-700">
        <div className="max-w-4xl mx-auto text-center">
